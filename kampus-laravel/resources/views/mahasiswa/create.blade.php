    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                {{-- Step 1: Choose Fakultas --}}
                <form method="GET" action="{{ url('/mahasiswa/create') }}" class="mb-6">
                    ...
                    <select name="fakultas_id" onchange="this.form.submit()"
                        ...
                        @foreach ($fakultas as $f)
                            <option value="{{ $f->id }}" {{ $selectedFakultas == $f->id ? 'selected' : '' }}>
                                {{ $f->nama_fakultas }}
                            </option>
                        @endforeach
                    </select>
                ...
                @if($selectedFakultas)
                    {{-- Step 2: Form tambah/edit mahasiswa --}}
